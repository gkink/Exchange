...
//	@Test
	public void testInsertAndSelect(){
		i.insert();
		ItemsChanged s= new ItemsChanged(d, q, 2);
		assertEquals(i.getItemName(),s.getItemName());
		assertEquals(i.getItemOwner(),s.getItemOwner());
		assertEquals(s.getItemId(),2);
		
		
	}
	@Test
	public void testDelete(){
		ItemsChanged s= new ItemsChanged(d, q, 4);
		s.delete();
	//	ItemsChanged a= new ItemsChanged(d, q, 4);
	//	assertEquals(a,null);
